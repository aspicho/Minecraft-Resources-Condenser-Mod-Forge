...
public class CondenserMenu extends AbstractContainerMenu  {
    ...
    public CondenserMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
        this(id, inventory, inventory.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public CondenserMenu(int id, Inventory inventory, BlockEntity entity, ContainerData data) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.CONDENSER.get());
    }
